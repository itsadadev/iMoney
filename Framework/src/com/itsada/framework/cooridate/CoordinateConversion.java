...
public class CoordinateConversion
{
  ...
  public LatLon2UTM latLonToUTM(double latitude, double longitude)
  {
    LatLon2UTM c = new LatLon2UTM();
    
    c.convertLatLonToUTM2(latitude, longitude);    
    return c;
  }
  ...
  public class LatLon2UTM
  {
	...
	public void convertLatLonToUTM2(double latitude, double longitude)
    {
      validate(latitude, longitude);

      setVariables(latitude, longitude);

      zone = getLongZone(longitude);
      LatZones latZones = new LatZones();
      zone += latZones.getLatZone(latitude);
