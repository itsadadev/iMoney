...
public class CreateLiabilityTransactionActivity extends BaseActivity implements
	...
	private LinearLayout amountMessageLayout, transactionCategoryMessageLayout,
			tranferMessageLayout, tvCategoryLayout, layoutTroggle;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.create_liability_transaction_layout);
			...
			imgFavorite.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					templateDialog = new TemplateDialog(
							CreateLiabilityTransactionActivity.this);
		...
		if (etAmount.getText().toString().equals("")
			...
			if (etAmount.getText().toString().equals("")) {
				...
				amountMessageLayout.startAnimation(AnimationUtils
						.loadAnimation(CreateLiabilityTransactionActivity.this,
